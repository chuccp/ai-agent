...
// Exec 执行节点
func (n *InputNode) Exec(state *State) (value.NodeValue, error) {
...
// Exec 执行节点
func (n *OutputNode) Exec(state *State) (value.NodeValue, error) {
	nodeValue, err := n.ParseNoRootValuesFromWithError(state, n.ValuesFrom)
	if err != nil {
		return nil, err
	}
	if n.outFunc != nil {
...
// NodeExecFunc 节点执行函数
type NodeExecFunc func(state *State) (value.NodeValue, error)
